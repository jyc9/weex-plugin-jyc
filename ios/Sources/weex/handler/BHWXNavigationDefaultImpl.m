...
@implementation BHWXBarButton

@end

@implementation BHWXNavigationDefaultImpl
#pragma mark -
        ...
        withContainer:(UIViewController *)container
{
    if (param[@"title"]) {
        ...
        BHWXBarButton *button = [BHWXBarButton buttonWithType:UIButtonTypeRoundedRect];
...
{
    BHWXBarButton *button = (BHWXBarButton *)sender;
